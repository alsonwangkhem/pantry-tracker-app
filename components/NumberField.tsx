...
const QuantityInput: React.FC<CustomNumberInputProps> = ({ quantity, setQuantity }) => {
  return <NumberInput aria-label="Quantity Input" min={1} max={99} quantity={quantity} setQuantity={setQuantity} />;
};
